...
function bones_ahoy() {
  ...
  // USE THIS FILE FOR CUSTOM FIELDS
...
function bones_register_sidebars() {
	...
	register_sidebar(array(
		'id' => 'sidebar-footer',
		'name' => __( 'Footer Widget Area', 'bonestheme' ),
		'description' => __( 'Add widgets to the footer area.', 'bonestheme' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
		'after_title' => '</h4>',
...
If you use this, don't forget to uncomment the
add_action below!
*/
function bones_fonts() {
  wp_enqueue_style('googleFonts', '//fonts.googleapis.com/css?family=Lato:400,700');
}
...
/*
Adding save/load of JSON for Advanced Custom Fields
*/
