...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    if ( is_singular() AND comments_open() AND (get_option('thread_comments') == 1)) {
		...
		wp_register_script( 'bones-nav', get_stylesheet_directory_uri() . '/library/js/navigation.js', array( 'jquery' ), '', true );
  ...
  add_theme_support( 'custom-logo',
	...
	register_nav_menus(
		array(
			...
			'second-nav' => __( 'Secondary Menu', 'bonestheme' ),   // secondary nav in header
			'footer-links' => __( 'Footer Links', 'bonestheme' ) // nav in footer
		)
	);
